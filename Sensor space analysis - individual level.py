...
from STWM_functions import perform_initial_analysis 
...
from STWM_functions import ica_apply
raw_data         = ica_apply(raw_data, ica,subject_name)

#### EVENTS
from STWM_functions import event_renaming
...
from STWM_functions import raw_data_saver
data                   = raw_data_saver(folder, raw_data, subject_name,meg)

#### EPOCHING
from STWM_functions import epochs_initialization
...
#### FOOOF FILTERING
from STWM_functions import fooof_application 
...
#### CSD CALCULATION
from STWM_functions import csd_average
from STWM_functions import csd_calc
